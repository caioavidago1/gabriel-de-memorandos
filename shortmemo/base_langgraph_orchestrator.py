...
- shortmemo/primario/langgraph_orchestrator.py
- shortmemo/gestora/langgraph_orchestrator.py  
- shortmemo/searchfund/langgraph_orchestrator.py

OBJETIVO: Eliminar ~90% de duplicação de código
