...
VERSÃO 4.0 - LangGraph para orquestração complexa
"""
...
SECTION_QUERIES = {
    "Introdução": (
        "search fund empresa oportunidade negócio tese investimento "
        "contexto mercado apresentação visão estratégica oportunidade"
    ),
    "Mercado": (
