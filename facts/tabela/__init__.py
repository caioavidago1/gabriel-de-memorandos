...
from facts.tabela.dre_table import DRETableGenerator, DRELineItem
...
from facts.tabela.dre_extraction_schema import DREValuesByYear, DRETableExtractionResult
