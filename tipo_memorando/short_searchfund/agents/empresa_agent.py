"""
Agente de Empresa - Short Memo Search Fund
...
class EmpresaAgent:
    """Agente especializado em geração de Empresa para Short Memo Search Fund."""
    ...
    def generate(
        ...
        system_prompt = f"""Você é um analista sênior de Private Equity com 15 anos de experiência escrevendo a seção "Empresa" de um Short Memo de Search Fund para o comitê de investimento da Spectra Capital.
...
§ PARÁGRAFO 1 - Fundação e Porte (2-3 frases):
  ...
  - Porte atual: "Com receita de R$ Xm e Y funcionários, a companhia se posiciona como..."
...
✅ Use **negrito** para: empresa ({company_name}), valores (R$ Xm), percentuais
...
Comece AGORA com o primeiro parágrafo (fundação e porte):"""
        ...
        system_prompt = enrich_prompt("empresa", system_prompt)
        messages = [
