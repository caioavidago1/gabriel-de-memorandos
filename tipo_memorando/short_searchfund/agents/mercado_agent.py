"""
Agente de Mercado - Short Memo Search Fund
...
class MercadoAgent:
    """Agente especializado em geração de Mercado para Short Memo Search Fund."""
    ...
    def generate(
        ...
        market_section = build_facts_section(
            facts, "market",
            {
                "market_size_brl": "Tamanho do mercado (BRL)",
                "market_size_usd": "Tamanho do mercado (USD)",
                "market_growth_cagr": "Crescimento CAGR (%)",
                "market_growth_period": "Período do CAGR",
                "market_drivers": "Principais drivers",
                "fragmentation_level": "Nível de fragmentação",
                "competition_intensity": "Intensidade competitiva",
                "main_competitors": "Principais competidores",
                "competitor_count": "Número de competidores",
                "barriers_to_entry": "Barreiras de entrada",
            }
        )
        ...
        qualitative_section = build_facts_section(
            facts, "qualitative",
            {
                ...
                "market_fragmentation": "Fragmentação do mercado",
                "market_segmentation": "Segmentação do mercado",
            }
        )
        ...
        competitive_advantages = get_text_safe(facts, "qualitative", "competitive_advantages")
        main_competitors = get_text_safe(facts, "qualitative", "main_competitors")
        ...
        system_prompt = f"""Você é um analista sênior de Private Equity com 15 anos de experiência escrevendo a seção "Mercado" de um Short Memo de Search Fund para o comitê de investimento da Spectra Capital.
...
§ PARÁGRAFO 1 - Mercado e Posicionamento (2-3 frases):
  ...
  - Tamanho e crescimento: mencione valores, CAGR com período
...
§ PARÁGRAFO 3 - Diferenciais Competitivos (formato numerado inline):
  - **OBRIGATÓRIO começar com:** "De acordo com o searcher, os principais diferenciais competitivos da **{company_name}** são:"
  ...
  - **SEMPRE** atribua ao searcher: "De acordo com o searcher..."
...
✅ **ATRIBUIÇÃO OBRIGATÓRIA** de diferenciais ao searcher
...
- Diferenciais competitivos segundo o searcher
...
2. Parágrafo 3 DEVE começar: "De acordo com o searcher, os principais diferenciais competitivos da **{company_name}** são:"
...
Comece AGORA com o primeiro parágrafo (tamanho e posicionamento do mercado):"""
        ...
        system_prompt = enrich_prompt("mercado", system_prompt)
