...
class FinancialsAgent:
    ...
    def generate(
        ...
        saida_section = build_facts_section(
            facts, "saida",
            {
                "cenario_base_ano_saida": "Ano da saída (cenário base)",
                "cenario_base_cagr_receita_pct": "CAGR Receita (%) cenário base",
                "cenario_base_margem_ebitda_pct": "Margem EBITDA (%) cenário base",
                "cenario_base_multiplo_saida_x": "Múltiplo de saída (x) cenário base",
                "cenario_base_tir_pct": "TIR (%) cenário base",
                "cenario_base_moic": "MOIC (x) cenário base",
                "cenario_alternativo_cagr_receita_pct": "CAGR Receita (%) cenário alternativo",
                "cenario_alternativo_margem_ebitda_pct": "Margem EBITDA (%) cenário alternativo",
                "saida_observacoes": "Observações sobre premissas e retornos",
            }
        )
...
**OUTPUT:** Apenas os 3-5 parágrafos, sem título de seção."""
        ...
        # ===== DRE (TABELA HISTÓRICO E PROJEÇÕES) =====
        # Short Memo Search Fund usa tabela DRE quando o usuário configurou "Visualização da Tabela"
        dre_section = ""
...
[SAÍDA - CENÁRIO BASE E ALTERNATIVO]
{saida_section}
{dre_section}
