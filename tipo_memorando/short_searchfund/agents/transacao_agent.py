    ...
    def generate(
        ...
        saida_section = build_facts_section(
            facts, "saida",
            {
                ...
                "cenario_base_multiplo_saida_ano": "Ano do múltiplo cenário base",
                "cenario_base_dividend_yield_pct": "Dividend Yield (%) cenário base",
                "cenario_base_tir_pct": "TIR (%) cenário base",
                "cenario_base_moic": "MOIC (x) cenário base",
                "cenario_alternativo_ano_saida": "Ano da saída (cenário alternativo)",
                "cenario_alternativo_tir_pct": "TIR (%) cenário alternativo",
                "cenario_alternativo_moic": "MOIC (x) cenário alternativo",
                "saida_observacoes": "Observações",
            }
        )
