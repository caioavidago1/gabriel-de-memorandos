"""
Orchestrator baseado em LangGraph para Short Memo Primário
...
from .._base.base_langgraph_orchestrator import BaseLangGraphOrchestrator


class PrimaryLangGraphOrchestrator(BaseLangGraphOrchestrator):
    """
    Orchestrator baseado em LangGraph para geração de Short Memo Primário.
    
    Herda toda a funcionalidade de geração de BaseLangGraphOrchestrator.
    Customização específica: section_queries para busca RAG Primária.
    """
    ...
    def __init__(
        ...
        """
        Inicializa o orchestrator do Primário.
