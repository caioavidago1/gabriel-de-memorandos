"""
Utilitários específicos para Primário - wrappers com defaults apropriados

DEPRECADO: Use facts.utils diretamente com context="primario"
"""
...
def get_currency_safe(
    ...
    Defaults apropriados para Primário.
...
def get_name_safe(
    ...
    Usa contexto "primario" para personalizar placeholders.
    ...
    Returns:
        Nome ou placeholder
    """
    return _get_name_safe(facts, section, field, default=default, context="primario")
